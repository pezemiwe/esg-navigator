...
const TELECOMMUNICATIONS_CONFIG: IndustryConfig = {
  ...
  modules: {
    visibleModuleIds: ["cra", "scenario"],
  },
  craLabels: {
    dataUploadTitle: "Infrastructure & Asset Data Upload",
    dataUploadSubtitle:
      "Upload telecommunications infrastructure and asset data for comprehensive climate risk assessment across your network operations.",
