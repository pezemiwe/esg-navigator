...
export default function ScreenResponseExport() {
  ...
  const handleExportExcel = () => {
    ...
    if (enrichedResults.length > 0) {
      ...
      const enrichRows = enrichedResults.map((e: any) => [
        e.asset,
        e.risk,
        e.tempChange,
        e.precipChange,
    ...
    <div className="flex-1 flex bg-[#F4F4F2] dark:bg-[#0D0D0D] min-h-[calc(100vh-140px)]">
      ...
      <div className="hidden lg:flex flex-col w-[250px] flex-shrink-0 border-r border-[#D8D8D8] dark:border-white/[0.07] bg-white dark:bg-[#111] px-5 py-8">
        ...
        <p className="text-[17px] text-[#888] dark:text-[#666] leading-relaxed mb-8">
          Prioritised action plan, monitoring schedule, and full XLSX export.
        </p>
        ...
        <div className="mt-auto pt-6 border-t border-[#E5E5E5] dark:border-white/[0.06] space-y-4">
          {[
            { label: "EAL Before", value: fmt(totalEalBefore), green: false },
            ...
            <div key={k.label}>
              ...
              <div
                className={`text-[15px] font-semibold leading-none ${k.green ? "text-[#86BC25]" : k.red ? "text-red-500" : "text-[#111] dark:text-[#F0F0F0]"}`}
              >
                {k.value}
              </div>
            </div>
      ...
      <div className="flex-1 px-6 md:px-10 xl:pr-16 py-8 space-y-6 overflow-y-auto">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
          {[
            ...
            <div
              key={k.label}
              className="p-4 border border-[#D8D8D8] dark:border-white/[0.07] bg-white dark:bg-[#111]"
        ...
        {/* Tabs */}
        <div className="flex border-b border-[#D8D8D8] dark:border-white/[0.07]">
          {TABS.map((tab, idx) => (
            <button
              key={tab}
          ...
          <div className="space-y-5">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
              {strategySummary.slice(0, 4).map(([strat, info], idx) => (
                <div
                  key={strat}
                  className="p-4 bg-white dark:bg-[#111] border border-[#D8D8D8] dark:border-white/[0.07]"
                  style={{
            ...
            <div className="bg-white dark:bg-[#111] border border-[#D8D8D8] dark:border-white/[0.07]">
              <div className="px-5 py-4 border-b border-[#E5E5E5] dark:border-white/[0.06] flex items-center justify-between">
                ...
                <table className="w-full border-collapse text-[12px]">
                  <thead className="sticky top-0 bg-[#F4F4F2] dark:bg-[#141414]">
                    <tr>
                      {[
                        ...
                        <th
                          key={h}
                          className="px-3 py-1.5 text-left text-[11px] font-semibold text-[#888] border-b border-[#D8D8D8] dark:border-white/[0.07] whitespace-nowrap"
                        >
                          {h}
                        </th>
                      ))}
                  ...
                  <tbody>
                    {actionPlan.map((r, i) => (
                      ...
                      >
                        <td className="px-3 py-1.5 border-b border-[#E5E5E5] dark:border-white/[0.05] text-[#888]">
                          {i + 1}
                        </td>
                        <td className="px-3 py-1.5 border-b border-[#E5E5E5] dark:border-white/[0.05] truncate max-w-[100px]">
                          {r.asset}
                        </td>
                        <td className="px-3 py-1.5 border-b border-[#E5E5E5] dark:border-white/[0.05] truncate max-w-[100px]">
                          {r.risk}
                        </td>
                        <td className="px-3 py-1.5 border-b border-[#E5E5E5] dark:border-white/[0.05]">
                        ...
                        <td className="px-3 py-1.5 border-b border-[#E5E5E5] dark:border-white/[0.05]">
                          <span
                            ...
                            style={{
                              ...
                              color: PRIORITY_COLORS[r.hazardRating] || "#888",
                            }}
                          >
                            {r.responseStrategy}
                          </span>
                        </td>
                        <td className="px-3 py-1.5 border-b border-[#E5E5E5] dark:border-white/[0.05] font-semibold text-red-500">
                          {fmt(r.ealLocal)}
                        </td>
                        <td className="px-3 py-1.5 border-b border-[#E5E5E5] dark:border-white/[0.05] font-semibold text-[#86BC25]">
        ...
        {tabValue === 1 && (
          <div className="space-y-5">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  {freqSummary.map(([freq, count], idx) => {
                    ...
                    return (
                      <div key={freq}>
                        ...
                        <div className="h-5 bg-[#F4F4F2] dark:bg-white/[0.04]">
                          <div
              ...
              {/* Monitoring schedule info cards */}
              <div className="space-y-3">
                {ORDERED_RATINGS.filter((r) =>
                  ...
                  .map((rating) => {
                    ...
                    return (
                      <div
                        key={rating}
                        className="p-3 border border-[#D8D8D8] dark:border-white/[0.07] bg-white dark:bg-[#111]"
                  ...
                  <tbody>
                    {kpiByRisk.map(([risk, d], i) => {
                      ...
                      return (
                        ...
                        >
                          <td className="px-3 py-1.5 border-b border-[#E5E5E5] dark:border-white/[0.05] truncate max-w-[120px]">
                            {risk}
                          </td>
                          <td className="px-3 py-1.5 border-b border-[#E5E5E5] dark:border-white/[0.05]">
                            <RatingPill rating={d.rating} />
                          </td>
                          <td className="px-3 py-1.5 border-b border-[#E5E5E5] dark:border-white/[0.05] text-red-500 font-semibold">
                            {fmt(d.ealBefore)}
                          </td>
                          <td className="px-3 py-1.5 border-b border-[#E5E5E5] dark:border-white/[0.05] text-[#86BC25] font-semibold">
                            {fmt(d.ealAfter)}
                          </td>
                          <td className="px-3 py-1.5 border-b border-[#E5E5E5] dark:border-white/[0.05]">
                            {red.toFixed(1)}%
        ...
        {tabValue === 2 && (
          <div className="space-y-4">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="p-6 bg-white dark:bg-[#111] border border-[#D8D8D8] dark:border-white/[0.07]">
                ...
                <p className="text-[13px] text-[#888] dark:text-[#666] mb-4 leading-relaxed">
                  7-sheet Excel workbook: Configuration, Asset Register, Hazard
                  Results, Enriched Results, Risk Summary, Response Plan,
                  Monitoring Plan.
                </p>
                <button
            ...
            <div className="px-4 py-3 border border-[#E5E5E5] dark:border-white/[0.06] bg-white dark:bg-[#111] text-[12px] text-[#888]">
              <span className="font-semibold text-[#555] dark:text-[#999]">
                Summary:{" "}
              </span>
              {results.length} risk combinations � {mappedAssets.length} assets
              � EAL {fmt(totalEalBefore)} ? {fmt(totalEalAfter)} (
